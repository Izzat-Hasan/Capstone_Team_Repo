...
<div class="wrapper bgded overlay" style="background-image:url('kaba-banner.jpg');">

  <div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
    <p>Homeless Community Help Center</p>
      <h3 class="heading">This application will help the homeless community better reach individuals willing to help</h3>
  ...
  <main class="hoc container clear"> 
    ...
    <section id="introblocks">
      <div  class="sectiontitle">
        <h6>The following options are services that we provide to help the homeless commuinty connect with individuals that are willing to donate and help</h6>
    
      </div>
      <ul class="nospace group">
        <li class="one_third first">
          <article><a >
            <h6 class="heading">Urgent Help</h6>
